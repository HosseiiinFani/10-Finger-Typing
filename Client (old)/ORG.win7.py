...
while run:
    ...
    caps_status = ctypes.WinDLL('User32.dll').GetKeyState(0x14)
...
##            print(x,y)
        if event.type == pygame.KEYDOWN:
            ...
            print (button_name,ord(button_name))
            ...
            if caps_status:
                 caps_p = True
            if caps_status == False:
                caps_p = False
        if event.type == pygame.KEYUP:
            keyup_name = event.key
            ...
            for x in button:
               if button_name == x and (shift_p or caps_p):
                   ...
                   print(amoroz)
               if button_name == x and not shift_p and not caps_p :
                   amoroz += button_name
                   print(amoroz)
            try:
